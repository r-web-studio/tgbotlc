...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "welcome": {
        "en": "Welcome to our educational bot! Choose an option below:",
        "ru": "Добро пожаловать в наш образовательный бот! Выберите опцию:",
        "uz": "Bizning ta'lim botiga xush kelibsiz! Quyidagi variantni tanlang:",
    },
    "help_text": {
        "en": (
    ...
    "enroll_start": {
        "en": "Great! Let's start your enrollment. What is your full name?",
        "ru": "Отлично! Начнём запись. Как ваше полное имя?",
        "uz": "Ajoyib! Yozilishni boshlaymiz. To'liq ismingiz nima?",
    },
    "ask_name": {
    ...
    "ask_phone": {
        ...
        "ru": "Введите номер телефона (напр., +998901234567):",
        "uz": "Telefon raqamingizni kiriting (masalan, +998901234567):",
    },
    "ask_level": {
        "en": "What is your current language level?\n\n1️⃣ Beginner (A1)\n2️⃣ Elementary (A2)\n3️⃣ Intermediate (B1)\n4️⃣ Upper-Intermediate (B2)\n5️⃣ Advanced (C1)\n6️⃣ Proficient (C2)",
        "ru": "Какой у вас текущий уровень языка?\n\n1️⃣ Начинающий (A1)\n2️⃣ Элементарный (A2)\n3️⃣ Средний (B1)\n4️⃣ Выше среднего (B2)\n5️⃣ Продвинутый (C1)\n6️⃣ Свободный (C2)",
        "uz": "Hozirgi tilingiz darajasi qanday?\n\n1️⃣ Boshlang'ich (A1)\n2️⃣ Elementar (A2)\n3️⃣ O'rta (B1)\n4️⃣ O'rtadan yuqori (B2)\n5️⃣ Yuqori (C1)\n6️⃣ Erkin (C2)",
    },
    "ask_goal": {
        "en": "What is your learning goal?",
        "ru": "Какова ваша цель обучения?",
        "uz": "O'rganish maqsadingiz nima?",
    },
    "ask_time": {
        "en": "Preferred class time?\n\n1️⃣ Morning (9:00-12:00)\n2️⃣ Afternoon (12:00-17:00)\n3️⃣ Evening (17:00-20:00)",
        "ru": "Удобное время занятий?\n\n1️⃣ Утро (9:00-12:00)\n2️⃣ День (12:00-17:00)\n3️⃣ Вечер (17:00-20:00)",
        "uz": "Qulay dars vaqti?\n\n1️⃣ Ertalab (9:00-12:00)\n2️⃣ Kun (12:00-17:00)\n3️⃣ Kechqurun (17:00-20:00)",
    },
    "enroll_complete": {
        "en": "✅ Enrollment submitted successfully! Our team will contact you soon.",
        "ru": "✅ Запись успешно отправлена! Наша свяжется с вами в ближайшее время.",
        "uz": "✅ Yozilish muvaffaqiyatli yuborildi! Bizning jamoamiz siz bilan tez orada bog'lanadi.",
    },
    "no_info": {
        "en": "Sorry, I don't have information on that. Please use the menu.",
        "ru": "Извините, у меня нет информации по этому вопросу. Используйте меню.",
        "uz": "Kechirasiz, bu haqda ma'lumotim yo'q. Iltimos, menyudan foydalaning.",
    },
    "error": {
